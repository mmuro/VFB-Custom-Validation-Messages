...
class VFB_Custom_Validation{
	...
	public function admin() {
		...
		if ( !get_option( 'vfb_validation_messages' ) )
			$messages = $this->message_defaults;
		else
			$messages = get_option( 'vfb_validation_messages' );
	...
	<div class="wrap">
		...
		<p><?php _e( 'Customize the jQuery validation messages for all Visual Form Builder or Visual Form Builder Pro forms', 'vfb-custom-validation' ); ?></p>
